    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <p className="mt-1 text-sm text-gray-500">Start managing your job search today</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
          ...
          <Input id="name" name="name" label="Full name" required placeholder="Jane Smith" autoComplete="name" />
